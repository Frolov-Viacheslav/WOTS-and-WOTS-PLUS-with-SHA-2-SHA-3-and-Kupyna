...
public class HashFunction {
    ...
    public String HashMessageHex(String input, Integer S, Integer choose){
        if(S == 256) {
            if (choose == 1)
                input = Sha2_256H(input);
            if (choose == 2)
                input = Sha3_256H(input);
            if (choose == 3)
                input = DSTU7564_256H(input);
        }
        if(S == 512) {
            if (choose == 1)
                input = Sha2_512H(input);
            if (choose == 2)
                input = Sha3_512H(input);
            if (choose == 3)
                input = DSTU7564_512H(input);
        }
        return input;
    }

    public String HashMessageBin(String input, Integer S, Integer choose){
        if(S == 256) {
            if (choose == 1)
                input = Sha2_256B(input);
            if (choose == 2)
                input = Sha3_256B(input);
            if (choose == 3)
                input = DSTU7564_256B(input);
        }
        if(S == 512) {
            if (choose == 1)
                input = Sha2_512B(input);
            if (choose == 2)
                input = Sha3_512B(input);
            if (choose == 3)
                input = DSTU7564_512B(input);
        }
        return input;
    }
